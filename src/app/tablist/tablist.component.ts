...
import {SearchBoxCmp} from './searchbox.component';
import {PlaylistCmp} from './playlist.component';
@Component({
	selector: 'tablist',
	entryComponents: [SearchBoxCmp, PlaylistCmp],
	template: `
		...
		<div class="container-fluid">
			<div class="row">
				...
				<div class="tab-content">
					<search-box [class.hide]="!isShowSearchTab"></search-box>
	...
	`,
	// provider: [SearchTabCmp, PlaylistCmp],
	styles: [`
	.tab-content{
			min-height: 300px;
	}
